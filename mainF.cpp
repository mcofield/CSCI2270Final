    ...
    while(mainMenu!=3){
        ...
        if(mainMenu == 1){
            ...
            while(lossCounter <= 1){
                ...
                if(currentRoom->funcIndex==4 || currentRoom->funcIndex==8 || currentRoom->funcIndex==12 || currentRoom->funcIndex==17 || currentRoom->funcIndex==21 || currentRoom->funcIndex==28 || currentRoom->funcIndex==29 || currentRoom->funcIndex==33){
                    outcome = dungeon.battle(50, 1, .5);
                }
                else{
